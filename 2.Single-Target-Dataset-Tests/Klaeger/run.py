...
if __name__ == "__main__":
    ...
    dataset=pd.read_excel("./010621_Klaeger_correct_table.xlsx", engine='openpyxl', nrows=244)
    ...
    max_combination_iter = 6 #the maximum number of inhibitor combinations to try (ex: 3 means using 3 inhibitors together in one mix)
    ...
    for x in range(0,5):
        ...
        excel_prefix = '010721_Klaeger_90thresh_x'+str(x)+'_'

        for new_mu in np.arange(200,1700,500):
