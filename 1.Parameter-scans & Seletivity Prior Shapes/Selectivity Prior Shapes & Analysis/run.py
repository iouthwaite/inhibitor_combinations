...
if __name__ == "__main__":
    ...
    for x in range(0,1):
        ...
        excel_prefix = '121221_PKIS2_full_90thresh_Inf0.1_optsteps_R1s5_R2s1p1_noise2p5_ALLRESULTS_x'+str(x)
