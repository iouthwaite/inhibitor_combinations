...
if __name__ == '__main__':
    ...
    max_combination_iter = 8 #the maximum number of inhibitor combinations to try (ex: 3 means using 3 inhibitors together in one mix)
    ...
    output_name = '121321_MET_EGFR_mu700' #Name of the output file
    num_p = 1 #number of proccesses to call during multiprocessing

    target_kinases = ['MET ', 'EGFR '] #Names of the target kinases - must match exactly with the characters in the dataset (be aware of spaces after the names!)
